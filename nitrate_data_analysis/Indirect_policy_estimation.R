...
smoothers_south_west <- readRDS("nitrate_data_analysis/output/smoothers/smoothers_south_west.rds")
...
smoothers_south_central <- readRDS("nitrate_data_analysis/output/smoothers/smoothers_south_central.rds")
...
smoothers_south_east <- readRDS("nitrate_data_analysis/output/smoothers/smoothers_south_east.rds")
...
smoothers_west_central <- readRDS("nitrate_data_analysis/output/smoothers/smoothers_west_central.rds")
...
smoothers_central <- readRDS("nitrate_data_analysis/output/smoothers/smoothers_central.rds")
...
smoothers_east_central <- readRDS("nitrate_data_analysis/output/smoothers/smoothers_east_central.rds")
...
smoothers_north_west <- readRDS("nitrate_data_analysis/output/smoothers/smoothers_north_west.rds")
...
smoothers_north_central <- readRDS("nitrate_data_analysis/output/smoothers/smoothers_north_central.rds")
...
smoothers_north_east <- readRDS("nitrate_data_analysis/output/smoothers/smoothers_north_east.rds")
